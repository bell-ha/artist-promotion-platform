...
| 카테고리 | 항목 |
|----------|------|
| Performer | Vocal, Musical |
| Player | Guitarist, Pianist, Drummer, Bassist, Orchestrator, Session Player |
| Creator | Composer, Songwriter, Beatmaker, Topliner, Producer |
| Sound | Sound Designer, Foley Artist, Audio Designer |
| Engineer | Recording Engineer, Mixing & Mastering Engineer, Live Engineer, Broadcast Engineer |
| Developer | Frontend Developer, Backend Developer, Fullstack Developer |
| Visual | Media Artist, Visual Artist, Technical Director |
...
t1_album_sections (유저당 1행)
  ...
  │     link, project_title, project_subtitle
  │     album_name, composer, category_desc, year, description
  │
  ├── t1_soundcloud_cards
  │     id, album_section_id, order
  │     link, project_title, project_subtitle
...
t1_contact_sections (유저당 1행)
  id, user_id
  phone1, phone2                    ← 전화번호 (선택)
  email1, email2, email3            ← 이메일 (email1 필수)
...
| PUT | `/profile/contact-section` | 🔒 | Contact Section 저장 |
...
- 아티스트 프로필 편집 (Template 1): Name / Album / Contact / Text 섹션
